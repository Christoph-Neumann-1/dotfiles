...
gpg-connect-agent updatestartuptty /bye >>/dev/null #Why does this need to be done???
export GPG_TTY=$(tty)
zstyle ':completion:*' completer _complete _ignored _correct _approximate _extensions
